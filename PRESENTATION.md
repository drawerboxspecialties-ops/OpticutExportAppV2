...
This app runs entirely in the browser. No server, no upload. You drop in a CSV and get split batches, printable cut lists, and OptiCut-ready export files.
...
src/ui/             HTML render helpers (cut-list print)
...
4. Print **Cut list** for the current batch, or **Cut lists** for all batches.
